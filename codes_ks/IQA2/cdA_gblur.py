...
######################### Testing the model ############################
filt_imgs = IQA_model.predict([x_test_noisy])

vis_clean = utils.visualize(x_train, [32, 32], [1, 1], [13, 13], color=1, channels='last')
vis_dist = utils.visualize(x_train_noisy, [32, 32], [1, 1], [13, 13], color=1, channels='last')
vis_filt = utils.visualize(filt_imgs, [32, 32], [1, 1], [13, 13], color=1, channels='last')
